...
var echref=function(text,gl,u,theme){return href(Hs+'www.echartsjs.com/examples/zh/editor.html?c='+(u||text.toLowerCase().replace(/ /g, '_'))+(gl?'&gl=1':'')+(theme?'&theme='+theme:''),text)};
