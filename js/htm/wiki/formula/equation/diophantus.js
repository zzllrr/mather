...
detail(ksc('x^2+y^3=z^5')+'有解',
	ksc([
		...
		'参数解之一：',
		Eq([['x','(t^{10} + 12^4) (t^{20} − 12^2 522 t^{15} − 12^4 10006 t^{10} + 12^6 522 t^5 + 12^8)'], '(u^2+v^2)(u^4-2‧3^{2}‧29u^3v-2‧5003u^2v^2+2‧3^{2}‧29uv^3+v^4)',
		'a(a^2-2^3‧3^2‧139u^2v^2-2‧3^{2}‧29u^3v+2‧3^{2}‧29uv^3)（令a=u^2+v^2）', 'a(a^2-2‧3^{2}vu(29u^2+2^2‧139vu-29v^2))',
		'a(a^2-2‧3^{2}vu(29b+2^2‧139vu))（令b=u^2-v^2）',
		'a(b^2-2‧3^{2}29bc-2^2‧41‧61c^2)（令c=uv，a^2-b^2=4c^2）',
		'a[(b-3^{2}29c)^2-5^7c^2]',
/*

f(u)=29u^2+4‧139‧12^2u-29‧12^4
Δ=(4‧139‧12^2)^2+4‧29^2‧12^4>0
f'(u)=2‧29u+4‧139‧12^2
...
b=1-12^4
c=v=12^2
a(a^2-2‧3^{2}v(29+2^2‧139v-29v^2))=(1+12^4)((1+12^4)^2-2‧3^{2}‧12^2‧(29+2^2‧139‧12^2-29‧12^4))

(1+12^4)((1-12^4-3^{2}*29*12^2)^2-5^7*12^4)
-12t(u^2-11uv-v^2)=12(12^4+11*12^2-1)

*/

		]),

		Eq([['y','−t^{20} − 12^3 19 t^{15} − 12^4 494 t^{10} + 12^7 19 t^5 − 12^8'], '-(u^4+2^2‧3‧19u^3v+2‧13‧19u^2v^2-2^2‧3‧19uv^3+v^4)',

		'-(a^2+2^2‧3‧19u^3v+2^2‧3‧41u^2v^2-2^2‧3‧19uv^3)（令a=u^2+v^2）', '-(a^2+2^2‧3vu(19u^2+41vu-19v^2))',
		'-(a^2+2^{2}‧3vu(19b+41vu))（令b=u^2-v^2）',
		'-(b^2+2^{2}‧3‧19bc+2^4‧31c^2)（令c=uv，a^2-b^2=4c^2）',
		'2^2‧5^5c^2-(b+2‧3‧19c)^2',

/*

g(u)=19u^2+41‧12^2u-19‧12^4
Δ=(41‧12^2)^2+4‧19^2‧12^4>0
g'(u)=2‧19u+41‧12^2
a=1+12^4
b=1-12^4
c=v=12^2
2^2‧5^5*12^4-(1-12^4+2‧3‧19*12^2)^2
-(a^2-2^2‧3vu(19u^2+41vu-19v^2))=-((1+12^4)^2+2^{2}‧3‧12^2‧(19+41‧12^2-19‧12^4))
...
*/
		...
		Eq([['z','-12t(t^{10} - 12^2 11 t^5 - 12^4)'], '-12t(u^2-11uv-v^2)',
		'-12t(b-11vu)（令b=u^2-v^2）',
		'12t(11c-b)（令c=uv，a^2-b^2=4c^2）',
		]),
		...
		'(4c^2+b^2)[(b-3^{2}29c)^2-5^7c^2]^2+[2^2‧5^5c^2-(b+2‧3‧19c)^2]^3=12v^2u(11c-b)^5',

		'令t=1=u',
		'即a=1+v^2，b=1-v^2，c=v=12^2',
