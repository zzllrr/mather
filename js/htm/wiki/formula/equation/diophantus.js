...
detail(ksc('x^2+y^3=z^5'),
	ksc([
		piece([
			'x= (t^{10} + 12^4) (t^{20} − 12^2522 t^{15} − 12^410006 t^{10} + 12^6522 t^5 + 12^8)'+kbr+
				'=(u^2+v^2)(u^4-18‧29u^3v-2‧5003u^2v^2+2‧3^{2}‧29uv^3+v^4)',
			'y=−t^{20} − 12^2228 t^{15} − 12^4494 t^{10} + 12^6228 t^5 − 12^8'+kbr+
				'=-(u^4+12‧19u^3v+2‧13‧19u^2v^2-12‧19uv^3+v^4)',
			'z=12(−t^{11} + 12^211 t^6 + 12^4t)'+kbr+
				'=-12t(u^2-11uv-v^2)',
			'u=t^5',
			'v=12^2'
		]),
		'36934790165857^2 + 240546239^3 = 267828^5（令t=1=u）',
...
detail('幂差方程'+ksc('x^a-y^b=n')+'解的情况统计如下',
	...
	Table([['幂差形式','=','差值','正整数解的情况']],Arrf(ksc,[
		...
		['x^a-y^a','=',['m(m^{a-1}+am^{a-2}n+⋯+an^{n-1})','【充要】省略的项，利用二项式展开','m(m^2+3n(m+n))','m((m+n)^2+n(n+m)+n^2)'].join(kbr+'='),'恒有解(m+n, n)'],
