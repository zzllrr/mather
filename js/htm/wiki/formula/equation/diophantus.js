...
detail(ksc(piece(['a^2+b^2=d^2','a^2+c^2=e^2','b^2+c^2=f^2','a^2+b^2+c^2=g^2（加上这一条，就是完美长方体）']))+br+
	...
	brA(ksc([
		...
		'最小的解(44, 117, 240 ; 125, 244, 267) \\text{Paul Halcke in 1719}即',
		piece([
		...
		piece(['(a,b,c)=(2^{2}‧11,3^{2}‧13,2^{4}‧3‧5)','(d,e,f)=(5^{3},2^{2}‧61,3‧89)','(u,v,w)=(2^2,3,5)']),
		...
		piece(['(a,b,c)=(5‧3^2‧11,2^{3}‧13‧47,2^{5}‧3‧5‧17)','(d,e,f)=(17^{3},3‧5^{2}‧109,2^{3}‧29‧41)','(u,v,w)=(3‧5,2^3,17)']),
		...
		'使用勾股数形式代替u,v→'+piece([
			...
			'v=k(2mn)=2kmn',
			'w=k(m^2+n^2)',
			'a=k^3(m^2-n^2)|m^4-14m^2n^2+n^4|=k^3(m+n)(m-n)|m^4-14m^2n^2+n^4|',
			'b=2k^3mn|3m^4-10m^2n^2+3n^4|',
			'c=8k^3mn(m^4-n^4)=8k^3mn(m+n)(m-n)(m^2+n^2)',
			'd=k^3(m^2+n^2)^3',
			'e=k^3(m^2-n^2)(m^4+18m^2n^2+n^4)',
			'f=2k^3mn(5m^4-6m^2n^2+5n^4)',
...
detail(ksc('a^3+b^3+c^3=d^3')+' 有无穷多组非平凡解，如(3,4,5,6)' ,
	...
	ksc([
		...
		'(3a^{2}-5ab-5b^{2})^{3}+(4a^{2}+4ab+6b^{2})^{3}+(5a^{2}+5ab-3b^{2})^{3}=(6a^{2}+4ab+4b^{2})^{3}（变体b→-b 或 a↔b）',
		'同一个二次项系数依次为（3,4,5,6），（-5,4,5,4），（-5,6,-3,4）',
		
		'b^{3}(a^{3}+b^{3})^{3}+a^{3}(a^{3}-2b^{3})^{3}+b^{3}(2a^{3}-b^{3})^{3}=a^{3}(a^{3}+b^{3})^{3}',
		'括号中三次项系数，及括号外的项的底分别为（1,1,2,1；1,-2,-1,1；b,a,b,a）',
		'a^{3}(a^{3}-b^{3})^{3}+b^{3}(a^{3}-b^{3})^{3}+b^{3}(2a^{3}+b^{3})^{3}=a^{3}(a^{3}+2b^{3})^{3}（变体b→-b或 a↔b）',
