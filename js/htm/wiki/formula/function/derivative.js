...
wiki['Formula/Function/Derivative']=Kx(
    detail(gM('Indefinite Integral & Derivative')+ksc('∫f→f→f\''),Table([['∫f（省略常数项）','函数f','1阶导数f\'','2阶导数f″','n阶导数f^{(n)}']],[
        ...
        ZLR('x\\ch^{-1}x+{\\ln(1-x^2)}\\/2____'+khrA(['\\th^{-1}x','1\\/2\\ln '+kfrac(['1+x','1-x'])])+'____'+kfrac([1,'1-x^2'])+'____'+kfrac(['2x','(x^2-1)^2']),'','____'),
        ZLR('x\\cth^{-1}x+{\\ln(x^2-1)}\\/2____'+khrA(['\\cth^{-1}x','1\\/2\\ln '+kfrac(['x+1','x-1'])])+'____'+kfrac([1,'x^2-1'])+'____-'+kfrac(['2x','(x^2-1)^2']),'','____'),
