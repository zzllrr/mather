...
wiki['Formula/Function/Derivative']=Kx(
    detail(gM('Indefinite Integral & Derivative')+ksc('∫f→f→f\''),Table([['∫f（省略常数项）','函数f','1阶导数f\'','2阶导数f″','n阶导数f^{(n)}']],[
        ...
        ZLR('-\\ln \\cos x____'+khrA(['\\tan x',kfrac(['\\sin x','\\cos x'])])+'____'+khrA(['\\sec^2x',kfrac([1,'\\cos ^2x'])+'=1+\\tan ^2x'])+'____2\\tan x⋅\\sec^2x____(三阶)~2\\sec^2x(\\sec^2x+2\\tan^2 x)','','____'),
        ZLR('\\ln \\sin x____'+khrA(['\\cot x',kfrac(['\\cos x','\\sin x'])])+'____'+khrA(['-\\csc^2x','-'+kfrac([1,'\\sin ^2x'])+'=-1-\\cot ^2x'])+'____2\\cot x⋅\\csc^2x____(三阶)-2\\csc^2x(\\csc^2x+2\\cot^2 x)','','____'),
    ...
    detail(gM('Derivative Application'),ksc([
        ...
        ['圆锥体积1\\/3πr^2h','圆锥侧面积πr\\sqrt{h^2+r^2}'].join(eq('','→')),
