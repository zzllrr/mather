...
wiki['Formula/Function/Iteration']=Kx(
    detail(gM('Iteration')+ksc('f_{-1}→x→f→f_2→f_n，f_0=x，f_1=f，f_2=f(f(x)))，f_{-n}=(f_{-1})_{n}=(f_n)_{-1}，f_{m+n}=f_m(f_n)=f_n(f_m)，f_{mn}=(f_m)_n=(f_n)_m'),
        ...
        [khrA([]), 
            ...
            khrA([Eq([['f_2','(x^2+1)^2+1'],'x^4+2x^2+2','x^2(x^2+2)+2']), 
                Eq([['f_3','(x^2(x^2+2)+2)^2+1'],'x^4(x^2+2)^2+4x^2(x^2+2)+5','x^8+4x^6+8x^4+8x^2+5']),
                ...
                Eq(['f_n','x^{2^n}+⋯+f_n(0)',
                    ...
                    '∫(2^nx^{2^n-1}+⋯x)\\d x+f_n(0)', 
                    '∫2^nf_{n-1}f_{n-2}⋯fx\\d x+f_n(0)'
                ]),
                Eq(["∫f_n'",
                    "∫f'(f_{n-1})f'(f_{n-2})⋯f'(f)f'",
                    "∫2^nf_{n-1}f_{n-2}⋯fx",


                ])
            ]),
            khrA(['\\small '+Eq(['f_{n}','f_{n-1}^2+1',
                    //zp('x^{2^{n-1}}+a_{2^{n-1}-2}x^{2^{n-1}-2}+⋯+a_2x^2+a_0')+'^2+1',

                    '(x^{2^{n-1}}+'+kbr+'a_{2^{n-1}-2}x^{2^{n-1}-2}+'+kbr+'⋯+'+kbr+'a_2x^2+'+kbr+'a_0)^2+1',

                    'x^{2^{n}}+'+kbr+'(2a_{2^{n-1}-2})x^{2^n-2}+'+kbr+'(2a_{2^{n-1}}a_{2^{n-1}-4}+'+kbr+'a_{2^{n-1}-2}^2)x^{2^n-4}+'+kbr+'⋯+a_0^2+1'

                    //'x^{2^{n}}+'+zp('2a_{2^{n-1}-2}')+'x^{2^n-2}+'+zp('2a_{2^{n-1}}a_{2^{n-1}-4}+a_{2^{n-1}-2}^2')+'x^{2^n-4}+⋯+a_0^2+1'
                ]),
                '无实不动点'
                ]),
        ...
        [khrA([]), 
            ...
            khrA([Eq([['f_2','(x^2-1)^2-1'],'x^4-2x^2','x^2(x^2-2)']), 
                Eq([['f_3','f(f_2)'],'x^4(x^2-2)^2-1','(x^2(x^2-2)+1)(x^2(x^2-2)-1)','(x^2-1)^2((x^2-1)^2-2)','x^8-4x^6+4x^4-1',
                    'f_2(f)','(x^2-1)^2((x^2-1)^2-2)','(x-1)^2(x+1)^2((x^2-1)^2-2)']),
    ...
    detail('递推式',
        ...
        Table([['递推关系','f_n','f_{-n}']],[
            ...
            [Eq(['f_n^2-f_{n-1}^2','(f_n-f_{n-1})(f_n+f_{n-1})','a']),'\\sqrt{x^2+na}','\\sqrt{x^2-na}'],
