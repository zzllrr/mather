...
detail('等幂和公式',Table([ZLR('前n项求和 记法 结果')],[
	...
	[ZLR3('',ZLR('1 2 3 ⋯ n'),'^3','+'),
		...
		'也可利用排列组合公式i^3=i(i-1)(i-2)+3i(i-1)+i=3!C_i^3+3!C_i^2+C_i^1'+kbr+
		'=3!C_{n+1}^4+3!C_{n+1}^3+C_{n+1}^2'
	],
	[ZLR3('',ZLR('1 2 3 ⋯ n'),'^4','+'),
		Eq([sum('i',1,'n','i^4','',''),
		...
		'也可利用排列组合公式i^4=i(i-1)(i-2)(i-3)+6i(i-1)(i-2)+7i(i-1)+i=4!C_i^4+6⋅3!C_i^3+7⋅2!C_i^2+C_i^1'+kbr+
	...
	[ZLR3('',ZLR('1 2 3 ⋯ n'),'^5','+'),
		...
		'也可利用排列组合公式i^5=i(i-1)(i-2)(i-3)(i-4)+(1+2+3+4)i(i-1)(i-2)(i-3)+\\frac{3^5-3(2^5-2)-3}{3!}i(i-1)(i-2)+\\frac{2^5-2}{2}i(i-1)+i=5!C_i^5+C_5^24!C_i^4+25C_i^3+15C_i^2+C_i^1'+kbr+
		'=5!C_{n+1}^6+C_5^24!C_{n+1}^5+25!C_{n+1}^4+15C_{n+1}^3+C_{n+1}^2'  
	],
	[ZLR3('',ZLR('1 2 3 ⋯ n'),'^6','+'),
		Eq([sum('i',1,'n','i^6','',''),
