...
detail('多项式恒等式（因式分解公式）',Table([ZLR('名称 记法 = 结果 性质')],[
    ...
    ['立方和与和的关系','a^3+b^3+c^3-3abc','=','(a+b+c)(a^2+b^2+c^2-ab-ac-bc)'],
    ['四元立方和','a^3+b^3+c^3+d^3-3(abc+abd+acd+bcd)','=','(a+b+c+d)(a^2+b^2+c^2+d^2-ab-ac-ad-bc-bd-cd)'],
    ['n元立方和',sum('i',1,'n','a_i^3','','')+'-3'+sum('','i < j < k','','a_ia_ja_k','',''),'=',sum('i',1,'n','a_i','','')+zp(sum('i',1,'n','a_i^2','','')+'-'+sum('','i < j','','a_ia_j','',''))],
	...
	['6次4项式','a^4+(2-c^2)a^2b^2+b^4','=',
		khrA(['(a^2+b^2)^2-a^2b^2c^2','(a^2+b^2+abc)(a^2+b^2-abc)'])
	],

	['4次2项式','4a^4+1','=',
		khrA(['(2a^2+1)^2-4a^2','(2a^2+2a+1)(2a^2-2a+1)','(2a(a+1)+1)(2a(a-1)+1)'])
		],

	['4次2项式','4a^4+b^4','=',
		khrA(['(2a^2+b^2)^2-4a^2b^2','(2a^2+b^2+2ab)(2a^2+b^2-2ab)','(2a(a+b)+b^2)(2a(a-b)+b^2)'])
	],

	['4次2项式','a^4+4','=',
		khrA(['(a^2+2)^2-4a^2','(a^2+2a+2)(a^2-2a+2)','((a+1)^2+1)((a-1)^2+1)','(a^2+2(1+a))(a^2+2(1-a))'])
	],


	['4次2项式','a^4+4b^4','=',
		khrA(['(a^2+2b^2)^2-4a^2b^2','(a^2+2b^2+2ab)(a^2+2b^2-2ab)','(a^2+2b(b+a))(a^2+2b(b-a))'])
	],

	['8次2项式','4a^4b^4+1','=',
		khrA(['(2a^2b^2+1)^2-4a^2b^2','(2a^2b^2+2ab+1)(2a^2b^2-2ab+1)','(2ab(ab+1)+1)(2ab(ab-1)+1)'])
		],

	['8次2项式','4a^4b^4+c^4','=',
		khrA(['(2a^2b^2+c^2)^2-4a^2b^2c^2','(2a^2b^2+c^2+2abc)(2a^2b^2+c^2-2abc)','(2ab(ab+c)+c^2)(2ab(ab-c)+c^2)'])
		],

	['8次2项式','a^4+4b^4c^4','=',
		khrA(['(a^2+2b^2c^2)^2-4a^2b^2c^2','(a^2+2b^2c^2+2abc)(a^2+2b^2c^2-2abc)','(a^2+2bc(bc+a))(a^2+2bc(bc-a))'])
		],


    ['2次齐次项和','a^2+ab+b^2','=',
		khrA(['(a+b)^2-ab','(a+b+√{ab})(a+b-√{ab})'])
		],
	...
	['n项和平方',kxA([sum('i',1,'n','a_i^2','','')+'+2'+sum('','i < j','','a_ia_j','','')]),'=',
		zp(sum('i',1,'n','a_i','',''))+'^2'
		],

	['N项和n方',sum('','\\tiny'+zp(sum('i','1','N','m_i','','')+'=n'),'',zp(frac('n!','\\tiny'+prod('i','1','N','m_i!','',''),''))+prod('i','1','N','a_i^{m_i}','',''),'',''),'=',
		zp(sum('i',1,'N','a_i','',''))+'^n'
		],
...
*/
	...
	['平方和乘积推广','(a^2+nb^2)(c^2+nd^2)','=',piece(['(ac-nbd)^2+n(ad+bc)^2','(ac+nbd)^2+n(ad-bc)^2'])+kbr+kxf(gM2('Brahmagupta Identity'))],
	['线性平方和乘积','(ma^2+nb^2)(mc^2+nd^2)','=',piece(['(mac-nbd)^2+mn(ad+bc)^2','(mac+nbd)^2+mn(ad-bc)^2'])],

	['平方差乘积','(a^2-b^2)(c^2-d^2)','=',piece(['(ac+bd)^2-(ad+bc)^2','(ac-bd)^2-(ad-bc)^2'])],
