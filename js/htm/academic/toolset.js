...
academic['Toolset']=
	Table([i18(ZLR('Name Type Features'))],[
		[inhref('wiki.html?q=Enclyclopedia','Enclyclopedia List'),'',''],
		...
		[href(Hs+'dlmf.nist.gov','NIST Digital Library of Mathematical Functions','','by (US) National Institute of Standards and Technology - NIST, part of the U.S. Department of Commerce')],
		[href(Hs+'faculty.evansville.edu/ck6/encyclopedia/ETC.html','ETC'),'','Encyclopedia of Triangle Centers by Clark Kimberling'],

		[href(Hs+'chrisvantienhoven.nl/mathematics/encyclopedia-of-poly-geometry','EPG'),'','by Chris van Tienhoven'+ul([
