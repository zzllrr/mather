...
technology['Software/Coding']=detail(gM('Tool'),Table([i18(ZLR('Name Type Summary'))],[
	[href(Hs+'www.tablesgenerator.com','Tables Generator'),'Table',''],
	[href(H+'shapecatcher.com','Unicode Character Recognition'),'Unicode',''],


	[href(Hs+'c.runoob.com','菜鸟工具'),'FrontEnd',''],

	[href(Hs+'edu.workbencheducation.com/toolbox/programming','Workbench Education'),'','The only place to build, find, customize, and share standards-aligned lessons for your classroom.'],

	[href(Hs+'bundle-buddy.firebaseapp.com','Bundle Buddy'),'','重复代码的可视化信息'],
