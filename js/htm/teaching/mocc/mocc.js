...
teaching['MOOC/MOOC']=
	Table([i18(ZLR('Name Type Features'))],[
        ...
        ['Open2Study','','澳大利亚，课程视频都放在 Youtube 上，比较难访问'],
        ['Spanish MOOC','','西班牙语学习平台'],
        ['FUN','','法国数字大学，法语授课'],
        ['Veduca','','巴西，葡萄牙语授课'],
        ['colmenia','','西班牙语和葡萄牙语，以程序开发和管理 方面的课程为主'],
        ['Schoo','','日语授课'],
        ['OpenUpED','','汇集了 12 门语言的欧盟平台'],
        ...
        ['学堂在线','',''],
        [href(H+'www.topu.com','顶你学堂'),'',''],
        ['华文慕课','',''],
        ['好大学在线CnMooc','',''],
        [href(H+'www.icourses.cn/oc/','爱课程'),'',''],
